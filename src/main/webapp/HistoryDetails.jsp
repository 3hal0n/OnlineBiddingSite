...
<br><br><br>
    ...
    <!-- Auction container that holds all the auction items -->
    <div class="auction-container">
        <c:forEach var="history" items="${allHistorys}">
            <div class="auction-item">
                <h3>${history.item_Title}</h3>
                <p><span>Auction ID:</span> ${history.auction_ID}</p>
                <p><span>Duration:</span> ${history.duration} days</p>
                <p><span>Description:</span> ${history.description}</p>
                <p><span>Start Bid Price:</span> ${history.start_Bid_Price}</p>
                
                <form action="DeleteServlet" method="post">
                <input type="hidden" name="id" value="${history.auction_ID}">
