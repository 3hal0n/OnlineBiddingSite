...
<meta charset="UTF-8">
   <!--   <meta name="viewport" content="width=device-width, initial-scale=1.0">-->
    ...
    <link rel="stylesheet" href="AddAuction.css">
...
<body>
    ...
    <div class="form-container">
        ...
        <h2>Add Auction</h2>
        <form action="add_auction" method="POST">
        
            <label for="item-title">Item Title:</label>
            <input type="text" id="item-title" name="item_title" required>

            <label for="item-duration">Item Duration (in days):</label>
            <input type="number" id="item-duration" name="item_duration" required>
            ...
            <input type="number" id="starting-bid" name="starting_bid" min="1" oninput="checkValue(this)"required>

            <input type="submit" class="create-auction-btn" name="submit_btn" id="Submit_BTN" value="Create Auction">
        ...
        <script>
  			function checkValue(input) {
    			if (input.value == 0) {
      				input.value = ''; 
      				alert("Zero is not allowed. Please enter a valid number for Auction price.");
    			}
  			}
		</script>
