...
public class UserController {
    ...
    public static boolean registerUser(UserModel user) {
        ...
        String sql = "INSERT INTO users (firstName, lastName, phoneNumber, email, password) VALUES (?, ?, ?, ?, ?)";
    ...
    public static boolean updateUserProfile(UserModel user) {
        ...
        String sql = "UPDATE users SET firstName = ?, lastName = ?, phoneNumber = ?, email = ? WHERE email = ?";
