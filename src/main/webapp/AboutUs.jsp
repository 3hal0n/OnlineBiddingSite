    ...
    <div class="container">
        ...
        <div class="content">
            <div class="content-item">
                <h2>Our Mission</h2>
                <p>At BIDHAVEN, we strive to provide the best online bidding experience for our users. Our mission is to create a transparent and efficient platform where buyers and sellers can interact seamlessly.</p>
            </div>

            <div class="content-item">
                <h2>Our Vision</h2>
                <p>We aim to revolutionize the auction industry by making it accessible to everyone, from casual bidders to seasoned professionals. We envision a future where online auctions become the preferred marketplace for all.</p>
            </div>

            <div class="content-item">
                <h2>Our Values</h2>
                <p>Integrity, innovation, and user satisfaction are at the core of everything we do. Our values drive us to improve constantly and provide the best service to our community of users.</p>
            </div>
        </div>
        ...
        <div class="team">
            ...
            <div class="content">
                <div class="content-item">
                    <img src="./images/leena.jpeg" alt="Team Member">
                    <h2>Leena Jilain</h2>
                    <p>CEO & Founder</p>
                </div>

                <div class="content-item">
                    <img src="./images/naduli.jpeg" alt="Team Member">
                    <h2>Naduli Weerasinghe</h2>
                    <p>CTO</p>
                </div>

                <div class="content-item">
                    <img src="./images/vibhu.jpeg" alt="Team Member">
                    <h2>Vibhu Kalpitha</h2>
                    <p>Head of Marketing</p>
                </div>

                <div class="content-item">
                    <img src="./images/shalon.jpg" alt="Team Member">
                    <h2>Shalon Fernando</h2>
                    <p>Lead Developer</p>
                </div>
            </div>
        </div>
